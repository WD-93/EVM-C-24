...
instance Print UnboxedRHS where
  prt i e = case e of
    URHS datacons -> prPrec i 0 (concatD [doc (showString "{"), prt 0 datacons, doc (showString "}")])

instance Print DataCon where
  prt i e = case e of
    DCArgs dca -> prPrec i 0 (concatD [prt 0 dca])
    DCRecord uident recordfields -> prPrec i 0 (concatD [prt 0 uident, doc (showString "{"), prt 0 recordfields, doc (showString "}")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ";"), prt 0 xs])
...
instance Print EField where
  prt i e = case e of
    EField id e_ -> prPrec i 0 (concatD [prt 0 id, doc (showString ":"), prt 0 e_])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print E where
  prt i e = case e of
    ...
    ConRecord uident efields -> prPrec i 13 (concatD [prt 0 uident, doc (showString "{"), prt 0 efields, doc (showString "}")])
    ...
    Bang e_1 e_2 -> prPrec i 12 (concatD [prt 12 e_1, doc (showString "!"), prt 13 e_2])
