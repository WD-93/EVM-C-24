    ...
    (b "memory" 55
       (b "continue" 46
          (b "_" 42
             ...
             (b "case" 44 (b "break" 43 N N) (b "code" 45 N N)))
          (b "for" 51
             (b "else" 49 (b "default" 48 (b "data" 47 N N) N) (b "end" 50 N N))
             (b "import" 53 (b "if" 52 N N) (b "instance" 54 N N))))
       (b "var" 64
          (b "tag" 60
             (b "return" 58
                (b "region" 57 (b "of" 56 N N) N) (b "storage" 59 N N))
             (b "tstorage" 62 (b "then" 61 N N) (b "type" 63 N N)))
          (b "|=" 69
             (b "{" 67 (b "while" 66 (b "where" 65 N N) N) (b "|" 68 N N))
             (b "}" 71 (b "||" 70 N N) (b "~" 72 N N)))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
